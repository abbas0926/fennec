    ...
    <div class="container py-3">
        <div class="row gap-y text-center text-md-left">
            <div class="col-md-4 mr-auto">
                ...
                <p>{{ config("app.name") }}, a carefully crafted and powerful HTML5 template, it's perfect to showcase your App or Startup</p>
            </div>
        ...
        <div class="row small">
            <div class="col-md-4">
                <p class="mt-2 mb-0 text-center text-md-left">© 2020 <a href="https://5studios.net">5studios</a>. All Rights Reserved</p>
            </div>
        </div>
    </div>
</footer>
